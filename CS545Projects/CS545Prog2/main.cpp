...
void printFuel() {
	...
	case 0: // Red Emergency Color
		...
		break;
	default:
		print("Fuel: ", GLUT_BITMAP_TIMES_ROMAN_24, PEN_DEBUG, titleXPos, yPos);
		print(fuel, GLUT_BITMAP_TIMES_ROMAN_24, PEN_DEBUG, valueXPose, yPos);
		break;
	}
}
...
void drawPauseButton() {
	...
	glEnd();
	print("Pause", GLUT_BITMAP_TIMES_ROMAN_24, PEN_DEBUG, 20, CANVAS_HEIGHT-43);
}
